...
<div style={{ margin: '2rem 0' }}>
  <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
    <svg xmlns="http://www.w3.org/2000/svg" 
     ...
     style={{ marginRight: '10px' }}
     preserveAspectRatio="xMidYMid meet">
  <path fill="black" d="M177.854,78.33c-0.584-9.011,0.583-17.922,0.908-26.921c0.239-6.634,0.01-15.805-4.484-21.218
...
<div style={{ margin: '2rem 0' }}>
  <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
    <svg xmlns="http://www.w3.org/2000/svg" 
     ...
     style={{ marginRight: '10px' }}
     preserveAspectRatio="xMidYMid meet">
  <path fill="black" d="M475.654,81.175c-0.036-1.077-0.071-2.153-0.107-3.234c-0.432-12.787-1.909-24.342-10.349-34.574
